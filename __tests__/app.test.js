...
describe('PATCH /api/articles/:article_id', () => {
  ...
  test('400: should return a 400 invalid type error if vote is of invalid type', () => {
    const newVotes = {
      inc_votes: 'banana',
    };
    return request(app)
  ...
  test('400: should return a 400 malformed request error if vote is of invalid type', () => {
    const newVotes = {
      inc_votes: 'banana',
    };
    return request(app)
